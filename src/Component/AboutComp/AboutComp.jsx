  ...
  return (
    <div className={styles.container}>
      <div className={styles.imageB4}>
        ...
        <div className={styles.hireMe_Con}>
          ...
          <div className={styles.links}>
           <a className={styles.btn} href="mailto:asehindej@gmail.com">HIRE ME</a>
          </div>
        </div>
      </div>
      <div className={styles.textCon}>
        ...
        <p>I&#39;m a Full Stack Web and Software Developer skilled in JavaScript, PHP, Node.js, and database management, with expertise in React, Next.js, Three.js and MongoDB. I continuously advance my career by learning and growing. I work closely with clients to deliver efficient, scalable solutions that solve real-world problems. Let&#39;s bring your ideas to life.</p>
        <div className={styles.more_details}>
          <h2>More Details</h2>
          {
            AboutData.map((data) => (
              <div key={data.title} className={styles.more_details_container}>
                <div className={styles.more_details_header}> <h2>{data.title}</h2>{data.title === moreDetails? <CiCircleMinus className={styles.more_icon} onClick={()=> setMoreDetails("")} /> : <CiCirclePlus className={styles.more_icon} onClick={()=> setMoreDetails(data.title)} />}</div>
                {
